...
if ($res['ok']): ?>
    ...
    <a class="btn-auth d-block text-center text-decoration-none" href="/Rongai/public/auth/login.php">Log in</a>
<?php else: ?>
    ...
    <div class="auth-foot"><a href="/Rongai/public/auth/login.php">Go to login</a></div>
<?php endif;
